        ...
        <div className="w-full bg-transparent text-white relative isolate overflow-x-hidden">
            ...
            <header className="relative min-h-screen flex flex-col lg:flex-row items-center justify-center gap-10 px-4 md:px-8 max-w-7xl mx-auto pt-16">
                <div className="text-center lg:text-left text-white max-w-2xl lg:max-w-xl">
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-4 leading-tight" style={{textShadow: '0 2px 20px rgba(0,0,0,0.7)'}}>Chinh phục Tiếng Anh cùng <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-200 via-emerald-300 to-stone-300">Grammatica</span></h1>
                    <p className="text-lg md:text-xl text-white/80 mb-8" style={{textShadow: '0 1px 10px rgba(0,0,0,0.7)'}}>Nền tảng học tập hiện đại dành riêng cho học sinh, kết hợp <KeywordHighlight>bài học tương tác</KeywordHighlight> và <KeywordHighlight>công nghệ AI đột phá</KeywordHighlight>.</p>
